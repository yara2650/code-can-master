...
import 'informationtester5.dart';
class InformationTester4Class extends StatefulWidget{
  State<InformationTester4Class> createState() => _pg();
}
class _pg extends State<InformationTester4Class> {
                    ...
                    children: [
                      Center(
                          child:Text("منين تشترى السكر ؟",
                              style: TextStyle(color: Color(0xff000000),fontWeight: FontWeight.w400,fontSize: 35
                              )
                          )
                      ),
                    ],
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester5Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
