...
import 'informationtester14.dart';

class InformationTester13Class extends StatefulWidget{
  State<InformationTester13Class> createState() => _pg();
}
class _pg extends State<InformationTester13Class> {
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester14Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
