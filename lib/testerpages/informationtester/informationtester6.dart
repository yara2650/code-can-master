...
import 'informationtester7.dart';

class InformationTester6Class extends StatefulWidget{
  State<InformationTester6Class> createState() => _pg();
}
class _pg extends State<InformationTester6Class> {
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester7Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
