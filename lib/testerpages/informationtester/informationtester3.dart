...
class InformationTester3Class extends StatefulWidget{
  State<InformationTester3Class> createState() => _pg();
}
class _pg extends State<InformationTester3Class> {
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      Center(
                          child:Text("علشان نخلى الميه تغلي",
                              style: TextStyle(color: Color(0xff000000),fontWeight: FontWeight.w400,fontSize: 30
                              )
                          )
                      ),
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester4Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
