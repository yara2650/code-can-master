...
import 'informationtester8.dart';

class InformationTester7Class extends StatefulWidget{
  State<InformationTester7Class> createState() => _pg();
}
class _pg extends State<InformationTester7Class> {
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester8Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
