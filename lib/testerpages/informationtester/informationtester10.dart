...
import 'informationtester11.dart';

class InformationTester10Class extends StatefulWidget{
  State<InformationTester10Class> createState() => _pg();
}
class _pg extends State<InformationTester10Class> {
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester11Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
