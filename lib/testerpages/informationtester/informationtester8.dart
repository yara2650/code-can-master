...
import 'informationtester9.dart';

class InformationTester8Class extends StatefulWidget{
  State<InformationTester8Class> createState() => _pg();
}
class _pg extends State<InformationTester8Class> {
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester9Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
