                  ...
                  Column(
                    children: [
                      Row(
                        ...
                        children: [
                          Text("الصباع دا اسمه ايه",style: TextStyle(fontSize:30,color: Color(0xff3E1C12) ),),
                          Text(" (1)",style: TextStyle(fontSize:30,color: Color(0xff3E1C12)  )),
                        ],
                      ),
                      // Center(
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester2Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
