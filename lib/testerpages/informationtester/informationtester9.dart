...
import 'informationtester10.dart';

class InformationTester9Class extends StatefulWidget{
  State<InformationTester9Class> createState() => _pg();
}
class _pg extends State<InformationTester9Class> {
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester10Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
