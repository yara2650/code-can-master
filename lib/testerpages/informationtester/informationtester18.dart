...
import 'informationtester19.dart';

class InformationTester18Class extends StatefulWidget{
  State<InformationTester18Class> createState() => _pg();
}
class _pg extends State<InformationTester18Class> {
              ...
              child: Column(
                children: [
                  ...
                  Column(
                    children: [
                      Center(
                          child:Text("إيه هي أعلى رتبة في",
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester19Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
