...
import 'informationtester12.dart';

class InformationTester11Class extends StatefulWidget{
  State<InformationTester11Class> createState() => _pg();
}
class _pg extends State<InformationTester11Class> {
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester12Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
