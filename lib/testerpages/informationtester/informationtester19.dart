...
import 'package:codecansecond/testerpages/totaltesterdegree.dart';

class InformationTester19Class extends StatefulWidget{
  State<InformationTester19Class> createState() => _pg();
}
class _pg extends State<InformationTester19Class> {
