...
import 'informationtester6.dart';
class InformationTester5Class extends StatefulWidget{
  State<InformationTester5Class> createState() => _pg();
}
class _pg extends State<InformationTester5Class> {
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester6Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
