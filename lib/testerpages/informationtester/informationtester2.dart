...
class InformationTester2Class extends StatefulWidget{
  State<InformationTester2Class> createState() => _pg();
}
class _pg extends State<InformationTester2Class> {
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester3Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
