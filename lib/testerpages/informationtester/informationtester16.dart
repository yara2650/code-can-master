...
import 'informationtester17.dart';

class InformationTester16Class extends StatefulWidget{
  State<InformationTester16Class> createState() => _pg();
}
class _pg extends State<InformationTester16Class> {
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester17Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
