...
import 'informationtester18.dart';

class InformationTester17Class extends StatefulWidget{
  State<InformationTester17Class> createState() => _pg();
}
class _pg extends State<InformationTester17Class> {
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester18Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
