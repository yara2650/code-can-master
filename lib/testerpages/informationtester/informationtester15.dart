...
import 'informationtester16.dart';

class InformationTester15Class extends StatefulWidget{
  State<InformationTester15Class> createState() => _pg();
}
class _pg extends State<InformationTester15Class> {
              ...
              child: Column(
                children: [
                  ...
                  Column(
                    children: [
                      Center(
                          child:Text("الزيت بيتعمل من إيه ؟",
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester16Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
