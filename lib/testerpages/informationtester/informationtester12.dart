...
import 'informationtester13.dart';

class InformationTester12Class extends StatefulWidget{
  State<InformationTester12Class> createState() => _pg();
}
class _pg extends State<InformationTester12Class> {
              ...
              child: Column(
                children: [
                  ...
                  Column(
                    children: [
                      Center(
                          child:Text("السكر بيتعمل من إيه ؟",
                    ...
                    onTap: (){
                      ...
                      if(check==true){
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return InformationTester13Class();
                        },));
                      }else {
                        setState(() {
                          text="select degree";
