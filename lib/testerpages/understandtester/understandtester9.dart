...
import 'understandtester10.dart';

class UnderstandTester10Class extends StatefulWidget {
  State<UnderstandTester10Class> createState() => _pg();
}

class _pg extends State<UnderstandTester10Class> {
        ...
        children: [
          ...
          Column(
            children: [
              ...
              Center(
                child: Text("على نظره قبل ما يدخل",
                    style: TextStyle(fontSize: 30, color: Color(0xff543686))),
              ),
              Center(
                child: Text("المدرسة" + "؟",
            ...
            onTap: () {
              ...
              if (check == true) {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) {
                    return UnderstandTester11Class();
                  },
                ));
              } else {
                setState(() {
