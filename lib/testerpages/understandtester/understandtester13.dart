...
import 'understandtester14.dart';

class UnderstandTester14Class extends StatefulWidget {
  State<UnderstandTester14Class> createState() => _pg();
}

class _pg extends State<UnderstandTester14Class> {
        ...
        children: [
          ...
          Column(
            children: [
              ...
              Center(
                child: Text("محامى ووكيل نيابة في ",
                    style: TextStyle(fontSize: 30, color: Color(0xff543686))),
              ),
              Center(
                child: Text(" معظم المحاكم" + "؟",
                    style: TextStyle(fontSize: 30, color: Color(0xff543686))),
              ),
            ],
          ),
            ...
            onTap: () {
              ...
              if (check == true) {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) {
                    return UnderstandTester15Class();
                  },
                ));
              } else {
                setState(() {
