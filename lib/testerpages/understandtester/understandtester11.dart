...
import 'understandtester12.dart';

class UnderstandTester12Class extends StatefulWidget {
  State<UnderstandTester12Class> createState() => _pg();
}

class _pg extends State<UnderstandTester12Class> {
        ...
        children: [
          ...
          Column(
            children: [
              ...
              Center(
                child: Text("إمتحان للى عاوزين",
                    style: TextStyle(fontSize: 30, color: Color(0xff543686))),
              ),
              Center(
                child: Text("يشتغلوا في الحكومة " + "؟",
                    style: TextStyle(fontSize: 30, color: Color(0xff543686))),
              ),
            ],
          ),
            ...
            onTap: () {
              ...
              if (check == true) {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) {
                    return UnderstandTester13Class();
                  },
                ));
              } else {
                setState(() {
