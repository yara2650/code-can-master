...
import 'understandtester13.dart';

class UnderstandTester13Class extends StatefulWidget {
  State<UnderstandTester13Class> createState() => _pg();
}

class _pg extends State<UnderstandTester13Class> {
            ...
            onTap: () {
              ...
              if (check == true) {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) {
                    return UnderstandTester14Class();
                  },
                ));
              } else {
                setState(() {
