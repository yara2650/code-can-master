...
import 'understandtester9.dart';

class UnderstandTester9Class extends StatefulWidget {
  State<UnderstandTester9Class> createState() => _pg();
}

class _pg extends State<UnderstandTester9Class> {
        ...
        children: [
          ...
          Column(
            children: [
              ...
              Center(
                child: Text("، ليه لازم ننجى الستات",
                    style: TextStyle(fontSize: 30, color: Color(0xff543686))),
              ),
              Center(
                child: Text("والأطفال الأول" + "؟",
                    style: TextStyle(fontSize: 30, color: Color(0xff543686))),
              ),
            ],
          ),
            ...
            onTap: () {
              ...
              if (check == true) {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) {
                    return UnderstandTester10Class();
                  },
                ));
              } else {
                setState(() {
