...
import 'understandtester6.dart';
import 'package:codecansecond/logicoperation/calculationdegree.dart';

class UnderstandTester6Class extends StatefulWidget {
  State<UnderstandTester6Class> createState() => _pg();
}

class _pg extends State<UnderstandTester6Class> {
        ...
        children: [
          ...
          Column(
            children: [
              ...
              Center(
                child: Text("شوفت قطر جاى بسرعة",
                    style: TextStyle(fontSize: 30, color: Color(0xff543686))),
              ),
              Center(
                child: Text("والقضبان مقطوعة" + "؟",
                    style: TextStyle(fontSize: 30, color: Color(0xff543686))),
              ),
            ],
          ),
