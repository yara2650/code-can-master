...
//import 'page9informations.dart';
import 'package:codecansecond/logicoperation/voice.dart';
import 'package:codecansecond/logicoperation/sqlflite2.dart';

class Information25Class extends StatefulWidget{
  State<Information25Class>createState()=> _pg();
}
class _pg extends State<Information25Class> {
  Reader obg=Reader();
  SqlDb sql= SqlDb();
              ...
              //margin: EdgeInsets.only(top: 50),
                ...
                child:Column(
                  children: [
                    ...
                    GestureDetector(
                        onTap: ()async{
                          question=await sql.readData("SELECT question FROM 'questiondata' WHERE department='i' AND id=23 ");
                    ...
                    GestureDetector(
                      ...
                      onTap: ()async{
                        List<Map> question=await sql.readData("SELECT grade , answer FROM 'questiondata' WHERE department='i' AND id=23 ");
                        ...
                        Navigator.of(context).pushNamed("ChoiceInformation1",
                            arguments: {"nextpage":"Information26Class","grade":grade,"answer":answer});
                      },
                      child: Container(
