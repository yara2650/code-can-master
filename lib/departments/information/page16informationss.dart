...
//import 'answerinformation21.dart';
import 'package:codecansecond/logicoperation/voice.dart';
import 'package:codecansecond/logicoperation/sqlflite2.dart';

class Information16Class extends StatefulWidget {
  State<Information16Class> createState() => _pg();
}

class _pg extends State<Information16Class> {
  Reader obg = Reader();
  SqlDb sql = SqlDb();
...
//يعنى إيه البريد المسجل ؟
                    ...
                    GestureDetector(
                        onTap: () async {
                          question = await sql.readData(
                              "SELECT question FROM 'questiondata' WHERE department='i' AND id=14 ");
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        //   return AnswerInformation21Class();
                        // },));
                        Navigator.of(context).pushNamed("Information17Class");
                      },
                      child: Container(
