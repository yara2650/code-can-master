...
//import 'answerinformation24.dart';
import 'package:codecansecond/logicoperation/voice.dart';
import 'package:codecansecond/logicoperation/sqlflite2.dart';

class Information19Class extends StatefulWidget {
  State<Information19Class> createState() => _pg();
}

class _pg extends State<Information19Class> {
  Reader obg = Reader();
  SqlDb sql = SqlDb();
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () async {
                          question = await sql.readData(
                              "SELECT question FROM 'questiondata' WHERE department='i' AND id=17 ");
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        //   return AnswerInformation24Class();
                        // },));
                        Navigator.of(context).pushNamed("Information20Class");
                      },
                      child: Container(
