...
import 'page31informationss.dart';
import 'package:codecansecond/logicoperation/voice.dart';
import 'package:codecansecond/logicoperation/sqlflite2.dart';

class Information30Class extends StatefulWidget{
  State<Information30Class>createState()=> _pg();
}
class _pg extends State<Information30Class> {
  Reader obg=Reader();
  SqlDb sql= SqlDb();
                ...
                child:Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text(' ما هي درجة حرارة جسم الإنسان ؟ ',
                    ...
                    GestureDetector(
                        onTap: ()async{
                          question=await sql.readData("SELECT question FROM 'questiondata' WHERE department='i' AND id=27 ");
                    ...
                    GestureDetector(
                      ...
                      onTap: ()async{
                        List<Map> question=await sql.readData("SELECT grade , answer FROM 'questiondata' WHERE department='i' AND id=27 ");
                        ...
                        Navigator.of(context).pushNamed("ChoiceInformation1",
                            arguments: {"nextpage":"Information31Class","grade":grade,"answer":answer});
                      },
                      child: Container(
