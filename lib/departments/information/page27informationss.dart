...
//import 'page11informations.dart';
import 'package:codecansecond/logicoperation/voice.dart';
import 'package:codecansecond/logicoperation/sqlflite2.dart';

class Information27Class extends StatefulWidget{
  State<Information27Class>createState()=> _pg();
}
class _pg extends State<Information27Class> {
  Reader obg=Reader();
  SqlDb sql= SqlDb();
                ...
                child:Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text('المتر فيه كام سنتيمتر ؟',
                    ...
                    GestureDetector(
                        onTap: ()async{
                          question=await sql.readData("SELECT question FROM 'questiondata' WHERE department='i' AND id=24 ");
                    ...
                    GestureDetector(
                      onTap: ()async{
                        List<Map> question=await sql.readData("SELECT grade , answer FROM 'questiondata' WHERE department='i' AND id=24 ");
                        ...
                        Navigator.of(context).pushNamed("ChoiceInformation1",
                            arguments: {"nextpage":"Information28Class","grade":grade,"answer":answer});
                      },
                      child: Container(
