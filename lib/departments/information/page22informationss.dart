              ...
              //margin: EdgeInsets.only(top: 50),
                ...
                child:Column(
                  children: [
                    ...
                    GestureDetector(
                        onTap: ()async{
                          question=await sql.readData("SELECT question FROM 'questiondata' WHERE department='i' AND id=20 ");
                    ...
                    GestureDetector(
                      onTap: ()async{
                       List<Map> question=await sql.readData("SELECT grade , answer FROM 'questiondata' WHERE department='i' AND id=20 ");
                       ...
                       // obg.speak(question[0]["question"]);
                        Navigator.of(context).pushNamed("ChoiceInformation1",
                            arguments: {"nextpage":"Information23Class","grade":grade,"answer":answer});
                      },
                      child: Container(
