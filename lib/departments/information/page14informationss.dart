...
//import 'answerinformation19.dart';
import 'package:codecansecond/logicoperation/voice.dart';
import 'package:codecansecond/logicoperation/sqlflite2.dart';

class Information14Class extends StatefulWidget {
  State<Information14Class> createState() => _pg();
}

class _pg extends State<Information14Class> {
  Reader obg = Reader();
  SqlDb sql = SqlDb();
            ...
            child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    //   ),
                    // ),
//يعنى إيه البريد المسجل ؟
                    SizedBox(
                      height: 290,
                    ),
                    Text("السكر بيتعمل من إيه ؟",
                        style: TextStyle(
                            color: Color(0xff000000),
                    ...
                    GestureDetector(
                        onTap: () async {
                          question = await sql.readData(
                              "SELECT question FROM 'questiondata' WHERE department='i' AND id=12 ");
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        //   return AnswerInformation19Class();
                        // },));
                        Navigator.of(context).pushNamed("Information15Class");
                      },
                      child: Container(
