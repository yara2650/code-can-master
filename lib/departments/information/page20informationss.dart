...
//import 'page29informations.dart';
import 'package:codecansecond/logicoperation/voice.dart';
import 'package:codecansecond/logicoperation/sqlflite2.dart';

class Information20Class extends StatefulWidget{
  State<Information20Class>createState()=> _pg();
}
class _pg extends State<Information20Class> {
  Reader obg=Reader();
  SqlDb sql= SqlDb();
                ...
                child:Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text('إيه هي أعلى رتبة في الجيش ؟',
                    ...
                    GestureDetector(
                      onTap: (){
                        ...
                        //   return Information29Class();
                        // },));
                        Navigator.of(context).pushNamed("Information21Class");
                      },
                      child: Container(
