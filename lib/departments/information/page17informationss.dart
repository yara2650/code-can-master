...
//import 'answerinformation22.dart';
import 'package:codecansecond/logicoperation/voice.dart';
import 'package:codecansecond/logicoperation/sqlflite2.dart';

class Information17Class extends StatefulWidget {
  State<Information17Class> createState() => _pg();
}

class _pg extends State<Information17Class> {
  Reader obg = Reader();
  SqlDb sql = SqlDb();
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () async {
                          question = await sql.readData(
                              "SELECT question FROM 'questiondata' WHERE department='i' AND id=15 ");
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        //   return AnswerInformation22Class();
                        // },));
                        Navigator.of(context).pushNamed("Information18Class");
                      },
                      child: Container(
