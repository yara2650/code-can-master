...
//import 'page10informations.dart';
import 'package:codecansecond/logicoperation/voice.dart';
import 'package:codecansecond/logicoperation/sqlflite2.dart';

class Information26Class extends StatefulWidget {
  State<Information26Class> createState() => _pg();
}

class _pg extends State<Information26Class> {
  Reader obg = Reader();
  SqlDb sql = SqlDb();
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Image(
                          image: AssetImage('images/information1-removebg.png'),
                          height: 160,
                          width: 160),
                    ),
                    GestureDetector(
                        onTap: () async {
                          question = await sql.readData(
                              "SELECT question FROM 'questiondata' WHERE department='i' AND id=29 ");
                    ...
                    GestureDetector(
                      onTap: () async {
                        List<Map> question = await sql.readData(
                            "SELECT grade , answer FROM 'questiondata' WHERE department='i' AND id=29 ");
