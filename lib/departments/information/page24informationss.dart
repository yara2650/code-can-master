...
//import 'page8informations.dart';
import 'package:codecansecond/logicoperation/voice.dart';
import 'package:codecansecond/logicoperation/sqlflite2.dart';

class Information24Class extends StatefulWidget{
  State<Information24Class>createState()=> _pg();
}
class _pg extends State<Information24Class> {
  Reader obg=Reader();
  SqlDb sql= SqlDb();
                ...
                child:Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text('الربع جنيه فيه كام قرش ؟ ',
                    ...
                    GestureDetector(
                        onTap: ()async{
                          question=await sql.readData("SELECT question FROM 'questiondata' WHERE department='i' AND id=22 ");
                    ...
                    GestureDetector(
                      ...
                      onTap: ()async{
                        List<Map> question=await sql.readData("SELECT grade , answer FROM 'questiondata' WHERE department='i' AND id=22 ");
                        ...
                        Navigator.of(context).pushNamed("ChoiceInformation1",
                            arguments: {"nextpage":"Information25Class","grade":grade,"answer":answer});
                      },
                      child: Container(
