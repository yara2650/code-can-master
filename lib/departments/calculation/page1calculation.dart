  ...
  Widget _buildPortraitLayout(){
    return Column(
          children: [
            ...
            SizedBox(height:MediaQuery.of(context).size.height*.05,),
            Image.asset('images/cup.png',height:MediaQuery.of(context).size.height*.2,
            ...
            Column(
              ...
              children: [
                Row(
                  //(1) ما عدد هذة المكعبات
                  mainAxisAlignment:MainAxisAlignment.center ,
                  children: [
                    Text(" ما عدد هذه المكعبات",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.09,color: Color(0xff543686) ),),
                    Text("(1)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.09,color: Color(0xff543686)  )),
                  ],
                ),
              ],
            ),
            GestureDetector(
                onTap: ()async{
                  question=await sql.readData("SELECT question FROM 'questiondata' WHERE department='c' AND id=1 ");
  ...
  Widget _buildLandscapeLayout(){
    return Column(
          children: [
            ...
            SizedBox(height:MediaQuery.of(context).size.height*.05,),
            Image.asset('images/cup.png',height:MediaQuery.of(context).size.height*.25,
            ...
            Column(
              ...
              children: [
                Row(
                  ...
                  mainAxisAlignment:MainAxisAlignment.center ,
                  children: [
                    Text(" ما عدد هذه المكعبات",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686) ),),
                    Text("(1)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686)  )),
                  ],
                ),
              ],
            ),
