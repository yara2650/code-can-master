...
class Calculation7Class extends StatefulWidget{
  State<Calculation7Class>createState()=> _pg();
}
class _pg extends State<Calculation7Class> {
  Reader obg=Reader();
  SqlDb sql= SqlDb();
  ...
  Widget _buildPortraitLayout(){
    return Column(
      children: [
        ...
        SizedBox(height:MediaQuery.of(context).size.height*.05,),
        Image.asset('images/cake.png',height:MediaQuery.of(context).size.height*.2,
          width:MediaQuery.of(context).size.width*.7 ,),
        SizedBox(height:MediaQuery.of(context).size.height*.05,),
        Column(
          children: [
            Row(
              //كان لدى البقال 12 رغيفًا وباع 5 منهم. كم عدد األرغفة التي تبقت لديه؟
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("كان لدى البقال 12 رغيفًا  ",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.07,color: Color(0xff543686) ),),
                Text("(7)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.07,color: Color(0xff543686)  )),
              ],
            ),
            Center(
              child: Text("وباع 5 منهم. كم عدد الأرغفة",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.07,color: Color(0xff543686)  )),
            ),
            Center(
        ...
        GestureDetector(
            onTap: ()async{
              question=await sql.readData("SELECT question FROM 'questiondata' WHERE department='c' AND id=7 ");
        ...
        GestureDetector(
          onTap: ()async{
            List<Map> question=await sql.readData("SELECT grade , answer FROM 'questiondata' WHERE department='c' AND id=7 ");
            ...
            Navigator.of(context).pushNamed("ChoiceCalculation",
                arguments: {"nextpage":"Calculation8Class","grade":grade,"answer":answer});
          }
          ,
          child:Container(
            width: MediaQuery.of(context).size.width*.4,
  ...
  Widget _buildLandscapeLayout(){
    return Column(
      children: [
        ...
        SizedBox(height:MediaQuery.of(context).size.height*.05,),
        Image.asset('images/cake.png',height:MediaQuery.of(context).size.height*.25,
        ...
        Column(
          ...
          children: [
            Row(
              ...
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("كان لدى البقال 12 رغيفًا وباع 5 منهم. كم عدد األرغفة التي تبقت لديه"+"؟",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686) ),),
