...
class Calculation13Class extends StatefulWidget{
  State<Calculation13Class>createState()=> _pg();
}
class _pg extends State<Calculation13Class> {
  Reader obg=Reader();
  SqlDb sql= SqlDb();
    ...
    return Column(
      children: [
        ...
        Column(
          children: [
            Row(
              //عدد 36 يساوي ثلثين ماذا من االعداد؟
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("عدد 36 يساوي ثلثين ماذا",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.06,color: Color(0xff543686) ),),
                Text("(13)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.06,color: Color(0xff543686)  )),
              ],
            ),
            Center(
              child: Text("من االاعداد؟",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.06,color: Color(0xff543686)  )),
            ),
            // Center(
        ...
        GestureDetector(
            onTap: ()async{
              question=await sql.readData("SELECT question FROM 'questiondata' WHERE department='c' AND id=13 ");
        ...
        GestureDetector(
          onTap: ()async{
            List<Map> question=await sql.readData("SELECT grade , answer FROM 'questiondata' WHERE department='c' AND id=13 ");
            ...
            Navigator.of(context).pushNamed("ChoiceCalculation",
                arguments: {"nextpage":"Calculation14Class","grade":grade,"answer":answer});
          }
          ,
          child:Container(
            width: MediaQuery.of(context).size.width*.4,
        ...
        Column(
          children: [
            Row(
              ...
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("عدد 36 يساوي ثلثين ماذا من الاعداد؟",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.02,color: Color(0xff543686) ),),
                Text("(13)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.02,color: Color(0xff543686)  )),
              ],
            ),
            // Center(
