...
class Calculation5Class extends StatefulWidget{
  State<Calculation5Class>createState()=> _pg();
}
class _pg extends State<Calculation5Class> {
  Reader obg=Reader();
  SqlDb sql= SqlDb();
    ...
    return Column(
      children: [
        ...
        Column(
          children: [
            Row(
              //أحمد كان معه 4 جنيهات، وأعطته أمه جنيهان إضافيان. كم مبلغ المال الذي يمتلكه اآلن؟
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("أحمد كان معه 4 جنيهات، وأعطته  ",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.07,color: Color(0xff543686) ),),
                Text("(5)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.07,color: Color(0xff543686)  )),
              ],
            ),
            Center(
              child: Text("أمه جنيهان إضافيان. كم مبلغ",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.07,color: Color(0xff543686)  )),
            ),
            Center(
              child: Text(" المال الذي يمتلكه الآن؟",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.07,color: Color(0xff543686)  )),
            ),
          ],
        ),
        GestureDetector(
            onTap: ()async{
              question=await sql.readData("SELECT question FROM 'questiondata' WHERE department='c' AND id=5 ");
        ...
        GestureDetector(
          onTap: ()async{
            List<Map> question=await sql.readData("SELECT grade , answer FROM 'questiondata' WHERE department='c' AND id=5 ");
            ...
            Navigator.of(context).pushNamed("ChoiceCalculation",
                arguments: {"nextpage":"Calculation6Class","grade":grade,"answer":answer});
          }
          ,
          child:Container(
            width: MediaQuery.of(context).size.width*.4,
        ...
        Column(
          ...
          children: [
            Row(
              ...
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("أحمد كان معه 4 جنيهات، وأعطته أمه جنيهان إضافيان. كم مبلغ المال الذي يمتلكه الآن؟"+"؟",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686) ),),
