...
class Calculation12Class extends StatefulWidget{
  State<Calculation12Class>createState()=> _pg();
}
class _pg extends State<Calculation12Class> {
  Reader obg=Reader();
  SqlDb sql= SqlDb();
    ...
    return Column(
      children: [
        ...
        Column(
          children: [
            Row(
              //اشترى التاجر 3 علب أقالم وكل علبة تساوي 100 قرش . كم المبلغ المتبقي لديه من 5 جنيهات؟
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("اشترى التاجر 3 علب أقلام وكل",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.06,color: Color(0xff543686) ),),
                Text("(12)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.06,color: Color(0xff543686)  )),
              ],
            ),
            Center(
              child: Text("علبة تساوي 100 قرش . كم المبلغ",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.06,color: Color(0xff543686)  )),
            ),
            Center(
        ...
        GestureDetector(
            onTap: ()async{
              question=await sql.readData("SELECT question FROM 'questiondata' WHERE department='c' AND id=12 ");
        ...
        GestureDetector(
          onTap: ()async{
            List<Map> question=await sql.readData("SELECT grade , answer FROM 'questiondata' WHERE department='c' AND id=12 ");
            ...
            Navigator.of(context).pushNamed("ChoiceCalculation",
                arguments: {"nextpage":"Calculation13Class","grade":grade,"answer":answer});
          }
          ,
          child:Container(
            width: MediaQuery.of(context).size.width*.4,
        ...
        Column(
          children: [
            ...
            //اشترى التاجر 3 علب أقالم وكل علبة تساوي 100 قرش . كم المبلغ المتبقي لديه من 5 جنيهات؟
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("اشترى التاجر 3 علب أقالم وكل علبة تساوي 100 قرش",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.02,color: Color(0xff543686) ),),
                Text("(12)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.02,color: Color(0xff543686)  )),
              ],
            ),
            Center(
