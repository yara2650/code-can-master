    ...
    return Column(
      children: [
        ...
        Column(
          children: [
            Row(
              //أربعة أولاد كانوا يملكون 72 بليه وقسموها بالتساوي كم عدد البليات التي يمتلكها كل طفل
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("أربعة أولاد كانوا يملكون 72 ",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.07,color: Color(0xff543686) ),),
                Text("(9)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.07,color: Color(0xff543686)  )),
              ],
            ),
            Center(
              child: Text("بليه وقسموها بالتساوي كم عدد",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.07,color: Color(0xff543686)  )),
            ),
            Center(
              child: Text("البليات التي يمتلكها كل طفل"+"؟",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.07,color: Color(0xff543686)  )),
            ),
        ...
        GestureDetector(
            onTap: ()async{
              question=await sql.readData("SELECT question FROM 'questiondata' WHERE department='c' AND id=10 ");
        ...
        GestureDetector(
          onTap: ()async{
            List<Map> question=await sql.readData("SELECT grade , answer FROM 'questiondata' WHERE department='c' AND id=10 ");
            ...
            Navigator.of(context).pushNamed("ChoiceCalculation",
                arguments: {"nextpage":"Calculation11Class","grade":grade,"answer":answer});
          }
          ,
          child:Container(
            width: MediaQuery.of(context).size.width*.4,
...
//أربعة أولاد كانوا يملكون 72 بليه وقسموها بالتساوي كم عدد البليات التي يمتلكها كل طفل
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("أربعة أولاد كانوا يملكون 72 بليه وقسموها بالتساوي كم ",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.02,color: Color(0xff543686) ),),
                Text("(10)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.02,color: Color(0xff543686)  )),
              ],
            ),
            Center(
              child: Text("عدد البليات التي يمتلكها كل طفل"+"؟",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.02,color: Color(0xff543686)  )),
            ),
          ],
        ),
        GestureDetector(
