    ...
    return  Column(
          children: [
            ...
            Column(
              children: [
                Row(
                   //لماذا من الأفضل عموما ً التبرع بالأموال للجمعيات الخيرية بدلً من إعطائها للشحاتين في الشوارع
                  mainAxisAlignment:MainAxisAlignment.center ,
                  children: [
                    Text("لماذا من الأفضل عموما ً",style: TextStyle(fontSize:30,color: Color(0xff543686) ),),
                    Text("(۱۰)",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                  ],
                ),
                Center(
                  child: Text("التبرع بالأموال للجمعيات الخيرية",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                ),
                Center(
                  child: Text("بدلً من إعطائها للشحاتين ",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                ),
                Center(
                  child: Text("في الشوارع",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                ),
              ],
            ),
             ...
             Column(
               children: [
                 Row(
                   ...
                   mainAxisAlignment:MainAxisAlignment.center ,
                   children: [
                     Text("لماذا من الأفضل عموما ً التبرع بالأموال للجمعيات",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686) ),),
                     Text("(۱۰)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686)  )),
                   ],
                 ),
                 Center(
                   child: Text("الخيرية بدلً من إعطائها للشحاتين في الشوارع؟",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686)  )),
                 ),
               ],
             ),
