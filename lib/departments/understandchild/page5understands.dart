    ...
    return Column(
          children: [
            ...
            Column(
              children: [
                Row(
                  //إذا رأيت قطارًا يقترب بسرعة وكانتَ السكة مقطوعة ماذا ستفعل
                  mainAxisAlignment:MainAxisAlignment.center ,
                  children: [
                    Text("إذا رأيت قطارًا يقترب بسرعة",style: TextStyle(fontSize:30,color: Color(0xff543686) ),),
                    Text("(٥)",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                  ],
                ),
                Center(
                  child: Text("وكانتَ السكة مقطوعة",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                ),
                Center(
            ...
            Column(
              children: [
                Row(
                  ...
                  mainAxisAlignment:MainAxisAlignment.center ,
                  children: [
                    Text("إذا رأيت قطارًا يقترب بسرعة وكانتَ السكة مقطوعة",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686) ),),
                    Text("(٥)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686)  )),
                  ],
                ),
                Center(
                  child: Text("ماذا ستفعل"+"؟",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686)  )),
                ),
              ],
            ),
            // Container(
