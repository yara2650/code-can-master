    ...
    return Column(
          children: [
            ...
            Column(
              children: [
                Row(
                  //لماذا يجب على الفرد فحص نظره قبل الدخول إلى المدرسة
                  mainAxisAlignment:MainAxisAlignment.center ,
                  children: [
                    Text("لماذا يجب على الفرد",style: TextStyle(fontSize:30,color: Color(0xff543686) ),),
                    Text("(٩)",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                  ],
                ),
                Center(
                  child: Text("فحص نظره قبل الدخول",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                ),
                Center(
                  child: Text("إلى المدرسة"+"؟",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
                ),
              ],
            ),
            // Container(
            ...
            Column(
              children: [
                Row(
                  ...
                  mainAxisAlignment:MainAxisAlignment.center ,
                  children: [
                    Text("لماذا يجب على الفرد فحص نظره قبل",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686) ),),
                    Text("(٩)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686)  )),
                  ],
                ),
                Center(
                  child: Text("الدخول إلى المدرسة"+"؟",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686)  )),
                ),
              ],
            ),
            // Container(
