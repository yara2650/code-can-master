    ...
    return Column(
          children: [
            ...
            Column(
              children: [
                Row(
                  //لماذا البيت المبني من الطوب أفضلَ من البيت المبني من الخشب
                  mainAxisAlignment:MainAxisAlignment.center ,
                  children: [
                    Text("لماذا البيت المبني من",style: TextStyle(fontSize:30,color: Color(0xff543686) ),),
            ...
            Column(
              children: [
                Row(
                  ...
                  mainAxisAlignment:MainAxisAlignment.center ,
                  children: [
                    Text("لماذا البيت المبني من الطوب أفضلَ من البيت",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686) ),),
                    Text("(٦)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686)  )),
                  ],
                ),
                Center(
                  child: Text("المبني من الخشب"+"؟",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686)  )),
                ),
              ],
            ),
            // Container(
