    ...
    return  Column(
      children: [
        ...
        Column(
          children: [
            Row(
              //لماذا يجب إنقاذ النساء و الأطفال في البداية عند غرق المركب
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("لماذا يجب إنقاذ النساء",style: TextStyle(fontSize:30,color: Color(0xff543686) ),),
                Text("(٨)",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
              ],
            ),
            Center(
              child: Text("و الأطفال في البداية عند",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
            ),
            Center(
              child: Text("غرق المركب"+"؟",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
            ),
        ...
        Column(
          children: [
            Row(
              ...
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("لماذا يجب إنقاذ النساء و الأطفال في البداية",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686) ),),
                Text("(٨)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686)  )),
              ],
            ),
            Center(
              child: Text(" عند غرق المركب"+"؟",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686)  )),
            ),
          ],
        ),
        // Container(
