    ...
    return Column(
      children: [
        ...
        Column(
          children: [
            Row(
              //(٧)  لماذا يجب أن تكون هناك قوانين
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("لماذا يجب أن تكون هناك",style: TextStyle(fontSize:30,color: Color(0xff543686) ),),
        ...
        Column(
          children: [
            Row(
              ...
              mainAxisAlignment:MainAxisAlignment.center ,
              children: [
                Text("لماذا يجب أن تكون هناك قوانين",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686) ),),
                Text("(٧)",style: TextStyle(fontSize:MediaQuery.of(context).size.width*.03,color: Color(0xff543686)  )),
              ],
            ),
            // Center(
            //   child: Text("قوانين"+"؟",style: TextStyle(fontSize:30,color: Color(0xff543686)  )),
